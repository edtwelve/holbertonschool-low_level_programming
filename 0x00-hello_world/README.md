This project is where we see the basics of the C language, we learn about the compiler and the different options the 'gcc command has. We also learn about the printf and puts command. 
